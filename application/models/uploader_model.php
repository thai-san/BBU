...
class Uploader_Model extends CI_Model{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/album/'.$this->get_u_id()."/temp/",
            // 'delete_url' => $this->get_full_url().'/uploader/do_upload',
            'delete_url' => $this->get_full_url().'uploader/do_upload',
            'upload_url' => $this->get_full_url().'/uploads/album/'.$this->get_u_id()."/temp/",
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
    ...
    protected function set_additional_file_properties($file) {
        // $file->deleteUrl = $this->options['script_url']."index.php/uploader/do_upload/"
        $file->deleteUrl = $this->options['script_url']."index.php?/uploader/do_upload/"
            .$this->get_query_separator($this->options['script_url'])
            .$this->get_singular_param_name()
